...
<%
	...
	if (flag != null && flag.equals("insert")) {
		...
		if(idKey == null || idKey.isEmpty()){
			...
			CommentBean.setBoard_comment_user_id(idKey);
		}
										...
										<tr>
											<div style="border: 1px solid black; margin-top: 10px;">
											    <div style="border-bottom: 1px solid black;">
											        ...
											        %>
											        <a><%=user_name %></a><a class="fa-solid fa-user font"></a>
											        ...
											        %>
											        <!-- 사용자일경우 comment_id랑 불러오는 user_id랑 같을경우로 변경 -->
											        <%
											        if(adminKey == null || adminKey.isEmpty()){
											        	if(idKey == comment_id || idKey.equals(comment_id)){
											        %>
