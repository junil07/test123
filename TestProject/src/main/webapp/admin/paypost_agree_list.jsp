...
totalRecord = Mgr.getagreelist(keyField, keytext, okay);
...
//페이징 처리
function list() {
	document.listFrm.action = "paypost_agree_list.jsp";
...
function read(num) {
    ...
    document.readFrm.action = "paypost_agreeview.jsp";
    document.readFrm.submit();
}
</script>
</head>
			...
			<div id="content" class="bg-white">
				...
				<div class="container-fluid">
					...
					<section class="container-xl">
						<header>
							<div >
								<h1 class="d-flex justify-content-center text-primary">유료 게시글 승인 관리</h1>
							</div>
							<div class="d-flex justify-content-center container-xl">
								<form class="d-flex justify-content-center container-xl" name = "searchFrm">
									...
									<select class="form-select form-select-lg mb-3 col-2 ml-1"  name = "okay" size = 1>
						...
						<main class="d-flex justify-content-center">
							<table class="table table-hover table-striped text-center">
								...
								<%
								Vector<PaypostBean> vlist = Mgr.agreePaypost(keyField, keytext, okay, start, cnt);
								for(int i = 0; i < vlist.size(); i++) {
								    ...
								    int agree = bean.getPaypost_agree();
								    String agreeText = "";
								    if (agree == 0) {
								        agreeText = "승인 대기중";
								    } else if (agree == 1) {
