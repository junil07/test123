...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#btn-read").on("click", function() {
			var _this_num = $(this).data("num");
			$("form#readFrm").find("input[name='num']").val(_this_num);
			$("form#readFrm").attr('action', "paypost_listview.jsp");
			$("form#readFrm").submit();
		});
	});*/
	...
	<section id="maincontent" class="maincontent">
		...
		<main class="main_content">
			<table class="main_list">
				...
				<%
				Vector<PaypostBean> vlist = Mgr.allPaypost(keyField, keyWord, start, cnt);
