...
public class Paypost_fileuploadBean {
	...
	private String paypsot_fileupload_server_name;
	private String paypost_fileupload_extension;
	private String paypost_fileupload_path;
	...
	public String getPaypsot_fileupload_server_name() {
		return paypsot_fileupload_server_name;
	}
	public void setPaypsot_fileupload_server_name(String paypsot_fileupload_server_name) {
		this.paypsot_fileupload_server_name = paypsot_fileupload_server_name;
	}
	...
	public String getPaypost_fileupload_path() {
		return paypost_fileupload_path;
	}
	public void setPaypost_fileupload_path(String paypost_fileupload_path) {
		this.paypost_fileupload_path = paypost_fileupload_path;
	}
