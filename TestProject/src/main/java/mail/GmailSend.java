...
public class GmailSend {
	...
	private static class SMTPAuthenticator extends Authenticator {
		public PasswordAuthentication getPasswordAuthentication() {
			return new PasswordAuthentication("tjdwls7979", "fdbyfmwhsgkrornr");
		}
	}
	public static void send(String title, String content, String toEmail) {
		...
		try {
			...
			Address fromAddr = new InternetAddress("perfect@perfect.com"); 
	...
	public static void main(String[] args) {
		...
		String content = "아래의 url을 통해 비밀번호 변경을 요청하세요\n 아헤헤헤헤헷 아와와와왓; 하와와왓;";
		String toEmail = "cktjdwls7979@naver.com";
