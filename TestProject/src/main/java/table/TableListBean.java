...
public class TableListBean {
	...
	private int tablelist_uploadfile_op;
	...
	public int getTablelist_uploadfile_op() {
		return tablelist_uploadfile_op;
	}
	public void setTablelist_uploadfile_op(int tablelist_uploadfile_op) {
		this.tablelist_uploadfile_op = tablelist_uploadfile_op;
	}
